...
def setup(client):
    ...
    async def blackjack(ctx, arg=None):
        ...
        if bet != None:
            ...
            embed = discord.Embed(description=f'**[ Bet: {coinEmoji} {"{:,}".format(bet)} ]**')
            ...
            while True:
                ...
                try:
                    ...
                    if interacted.data['custom_id'] == 'stand':
                        ...
                        embed_dict = embed.to_dict()
                        embed_dict["description"] = f'**[ Bet: {coinEmoji} {"{:,}".format(bet)} ]** {resultText}'
            ...
            view = discord.ui.View()
            embed = discord.Embed(description=f'**[ Bet: {coinEmoji} {"{:,}".format(bet)} ]** {resultText}',color=color)
            embed.set_author(name=f'{ctx.author.display_name} is playing Blackjack', icon_url=ctx.author.display_avatar)
